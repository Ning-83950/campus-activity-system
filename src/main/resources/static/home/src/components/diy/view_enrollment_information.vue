		...
		methods: {
          ...
          this.form["registration_date"] = this.$toTime(parseInt(this.form["registration_date"]),"yyyy-MM-dd")
			...
			get_obj_after(json, func){
																																														...
																																														if(json.result.obj["registration_date"]=="0000-00-00"){
				  json.result.obj["registration_date"] = null;
				}
				if(parseInt(json.result.obj["registration_date"]) > 9999){
					json.result.obj["registration_date"] = this.$toTime(parseInt(json.result.obj["registration_date"]),"yyyy-MM-dd")
				}
