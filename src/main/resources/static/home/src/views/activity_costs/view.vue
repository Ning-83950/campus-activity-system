				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 活动费用 -->
							<div><span>活动费用</span></div>
							<view_activity_costs v-if="$check_action('/activity_costs/view','get')"></view_activity_costs>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_activity_costs from "../../components/diy/view_activity_costs.vue";
	export default {
		data() {
			return {
			};
