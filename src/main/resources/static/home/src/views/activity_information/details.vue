<template>
	<div class="diy_details page_activity_information" id="activity_information_details">
		...
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_activity_information'>
							<div_activity_information :obj="obj"></div_activity_information>
...
<script>
	import div_activity_information from "@/components/diy/div_activity_information.vue";
	...
	export default {
		...
		methods:{
			...
			add_hits(obj) {
				obj["hits"] = obj["hits"] + 1;
				var hits = obj["hits"];
				this.$post('~/api/activity_information/set?activity_information_id=' + obj["activity_information_id"], {
					hits
				}, (res) => {
					if(res.result){
			...
			async get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.activity_information_id;
																		}
			},
																	/**
			 * 初始化收藏状态
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "activity_information",
					source_field: "activity_information_id",
					source_id: obj["activity_information_id"],
					user_id
				};
