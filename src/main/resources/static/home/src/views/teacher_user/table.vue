				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 教师用户 -->
							<div><span>教师用户</span></div>
							<table_teacher_user v-if="$check_action('/teacher_user/table','get')"></table_teacher_user>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_teacher_user from "../../components/diy/table_teacher_user.vue";
	export default {
		data() {
			return {
			};
